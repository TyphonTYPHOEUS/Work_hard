...
- (ARObjectView *)viewForCoordinate:(ARGeoCoordinate *)coordinate floorLooking:(BOOL)floorLooking {
    ...
    if (floorLooking) {
        ...
        UIImageView *boxView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"1.jpg"]];
    
        
        boxView.frame = CGRectMake(0, 0, 200, 200);
